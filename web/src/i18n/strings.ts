  ...
  id: {
    ...
    play: {
      ...
      result: {
        ...
        playAgain: "Main Lagi",
        shareToPlaza: "Bagikan ke Plaza",
        sharingToPlaza: "Membagikan...",
        shareToPlazaError: "Gagal membagikan ke Plaza",
        shareText: "Baru saja main BINGO di TheBingoFi!",
      },
      quests: {
        title: "Quest Selesai",
    ...
    plaza: {
      ...
      attachBoardLabel: "Lampirkan board",
      attachBoardActive: "Board terlampir",
      ...
      resultWon: "Menang",
      resultLost: "Kalah",
      resultCalls: "panggilan",
      resultOpponentPrefix: "Lawan: ",
      boardAttachmentLabel: "Board",
  ...
  en: {
    ...
    play: {
      ...
      result: {
        ...
        sharingToPlaza: "Sharing...",
        shareToPlazaError: "Failed to share to Plaza",
        shareText: "Just played a round of BINGO on TheBingoFi!",
      },
      quests: {
    ...
    plaza: {
      ...
      attachBoardLabel: "Attach board",
      attachBoardActive: "Board attached",
