  ...
  return (
    <main className="mx-auto max-w-2xl py-4 sm:py-8">
      ...
      <section className="relative rounded-lg border border-glacier/50 bg-night/75 p-1.5 shadow-[0_0_45px_-12px_rgba(58,124,184,0.55)] backdrop-blur-md">
        <div className="relative rounded border border-glacier/25 px-3 py-6 sm:px-10 sm:py-8">
          {/* Sudut bracket */}
          ...
          <header className="mb-5 space-y-3 text-center">
            <div className="mx-auto flex w-fit items-stretch border border-glacier/50">
              <span
                aria-hidden
                className="grid w-10 place-items-center border-r border-glacier/50 font-display text-lg font-bold text-frost sm:w-12 sm:text-xl"
              >
                !
              </span>
              <h1 className="px-3 py-2.5 font-display text-base font-bold uppercase tracking-[0.2em] text-frost sm:px-6 sm:py-3 sm:text-2xl sm:tracking-[0.3em]">
                {t.panelTitle}
              </h1>
            </div>
